  ...
  const metricsColors = [
    {
      light: "bg-sky-light",
      dark: "bg-sky-dark",
      textLight: "text-sky-darker",
      textDark: "text-sky-lightest",
    },
    {
      light: "bg-blue-light",
      dark: "bg-blue-dark",
      textLight: "text-blue-darker",
      textDark: "text-blue-lightest",
    },
    {
      light: "bg-indigo-light",
      dark: "bg-indigo-dark",
      textLight: "text-indigo-darker",
      textDark: "text-indigo-lightest",
    },
  ];
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        {metricsColors.map((color, index) => {
          ...
          const value =
            index === 0
              ...
              ? `${totalUnits} L`
              : `${totalCost} KES`;
          const subtitle = index === 0 ? "This Week" : "Cumulative";

          return (
            <div
              key={index}
              className={`${cardClass} w-full md:w-1/3 ${
                darkMode ? color.dark : color.light
              } ${darkMode ? color.textDark : color.textLight}`}
            >
      ...
      <section className="flex flex-col md:flex-row gap-4">
        {/* Units Line Chart */}
        <div
          className={`${cardClass} w-full md:w-1/2 h-80 ${
            darkMode ? "bg-gray-900 text-sky-lightest" : "bg-sky-lightest text-sky-darker"
          }`}
        >
          <div className="flex justify-between items-center mb-2 sm:mb-4 flex-wrap gap-2">
            ...
            <button
              ...
              className={`px-3 py-2 ${
                darkMode ? "bg-blue-dark hover:bg-blue" : "bg-blue hover:bg-blue-dark"
              } text-white rounded-lg transition flex items-center gap-2 shadow-md`}
            >
        ...
        <div
          className={`${cardClass} w-full md:w-1/2 h-80 ${
            darkMode ? "bg-gray-900 text-indigo-lightest" : "bg-indigo-lightest text-indigo-darker"
          }`}
        >
          <div className="flex justify-between items-center mb-2 sm:mb-4 flex-wrap gap-2">
            ...
            <button
              ...
              className={`px-3 py-2 ${
                darkMode ? "bg-cyan-dark hover:bg-cyan" : "bg-cyan hover:bg-cyan-dark"
              } text-white rounded-lg transition flex items-center gap-2 shadow-md`}
            >
